                ...
                if (compositionPropertyType.IsList ()) {
                    ...
                    if (compositionListValue != null) {
                        foreach (var auth in compositionListValue) {
                            ...
                            if (currentEntity == null) { //Adicionar
                                Session.Add (auth);
                            } else { //update
                    ...
                    if (currentEntity == null) {
                        if (compositionValue == null) { // Não tem no bd e nem no objeto
                            continue;
                        } else { // Não tem no BD e precisa adicionar
                            Session.Add (compositionValue);
                            continue;
                        }
                    } else {
                        if (compositionValue == null) { // Tem no bd, mas precisa ser removido
                            Session.RemoveRange (currentEntity);
                            continue;
                        } else { // Tem no bd e precisa ser atualizado
